...
\begin{figure}
    ...
    \subfloat[Isomerization Unit]{
        \includegraphics[width=0.45\linewidth]{fig/isomUnit.jpg}
        \label{fig:isomUnit}
    }
    ...
    Credit: \href{https://salavat-neftekhim.gazprom.com/press/news/2017/06/36/}{Gazprom neftekhim Salavat} \cite{noauthor_state---art_nodate}.
\end{figure}
...
\begin{figure}
    ...
    Credit: Cartoon \copyright Glasbergen, used with special permission from \url{www.glasbergen.com} \cite{noauthor_todays_nodate}.
\end{figure}
...
\begin{enumerate}
    ...
    \item Chapter \ref{chap:futureWork}, Future Work, discusses future work.
