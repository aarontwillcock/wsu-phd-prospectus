...
\clearpage \subsection{Related Work}  \label{chap:related work}
...
\clearpage \subsection{Electronics Background}\label{chap:electronics background}
...
\clearpage \subsection{Electronic System Model}\label{chap:electronic system model}
...
\clearpage \subsection{Methods of Protection}\label{chap:method of protection}
...
\clearpage \subsection{Real-time System Model}\label{chap:real-time system model}
...
\clearpage \subsection{Model Optimization}\label{chap:model optimization}
...
\clearpage \subsection{Experiments}\label{chap:experiments}
...
\clearpage \subsection{Results}\label{chap:results}
...
\clearpage \subsection{Conclusion} \label{subs:conclusion}
